 ...
 *
 *   Visit the official site from this fork at http://github.com/LukasRat/
 *
 * » Original project:
...
define('UASECO_BUILD', '2026-03-29');
define('UASECO_WEBSITE', 'https://github.com/LukasRat');
...
class UASECO extends Helper
{
	...
	public function run()
	{
		...
		$this->parser = new UasecoXmlParser();
	...
	private function sendHeader()
	{
		...
		$this->console_text('» Author:	LukasRat');
...
//					$this->console('[Plugin] The Plugin ['. $plugin->getClassname() .'] wants the Plugin ['. $dependence->classname .'] to run full featured, if you want, add the wanted Plugin in [config/plugins.xml].');
	...
	private function connectDedicated()
	{
		...
		// Allow Docker hostnames by removing strict IPv4 validation
		/*
