	...
	public function chat_eyeset ($aseco, $login, $chat_command, $chat_parameter) {
		...
		if (strtoupper($chat_parameter) == 'RELOAD') {
			if ($aseco->server->gamestate == Server::RACE) {
				...
				$this->onLoadingMap($aseco, $aseco->server->$F00MAPS->current);
...
//			$player->data['PluginRecordsEyepiece']['Maplist']['Filter'] = array('key' => $command['params']);	// already setup in chat_list()!
		...
		if ($require_action == true) {
			if ($player->data['PluginRecordsEyepiece']['Window']['Action'] == 'showDedimaniaRecordsWindow') {
				...
				$this->buildScorelistWindowEntryNEW($player, 'TOP_RANKINGS', array('score', 'nickname'));
	...
	*/
	...
	public function buildAddToFavoriteWidget ($mode = 'RACE') {
		...
		if ($this->config['FAVORITE_WIDGET'][0][$mode][0]['BACKGROUND_DEFAULT'][0] != '') {
			$bg = '<quad pos="0 0" z-index="0.001" size="11.5 12.19" bgcolor="222233BB'. $this->config['FAVORITE_WIDGET'][0][$mode][0]['BACKGROUND_DEFAULT'][0] .'" bgcolorfocus="'. $this->config['FAVORITE_WIDGET'][0][$mode][0]['BACKGROUND_FOCUS'][0] .'" scriptevents="1" id="ButtonAddToFavoriteWidget"/>';
		}
		else {
	...
	public function buildManiaExchangeWidget () {
		...
		if ( isset($aseco->server->maps->current->mx->id) ) {
			...
			if ($this->config['MANIAEXCHANGE_WIDGET'][0]['BACKGROUND_DEFAULT'][0] != '') {
				$xml .= '<quad pos="0 0" z-index="0.001" size="11.5 12.19" bgcolor="222233BB'. $this->config['MANIAEXCHANGE_WIDGET'][0]['BACKGROUND_DEFAULT'][0] .'" bgcolorfocus="'. $this->config['MANIAEXCHANGE_WIDGET'][0]['BACKGROUND_FOCUS'][0] .'" scriptevents="1" id="ButtonManiaExchangeWidget"/>';
			}
			else {
			...
			$xml = $this->templates['MANIA_EXCHANGE']['HEADER'];
			if ($this->config['MANIAEXCHANGE_WIDGET'][0]['BACKGROUND_DEFAULT'][0] != '') {
				$xml .= '<quad pos="0 0" z-index="0.001" size="11.5 12.19" bgcolor="222233BB'. $this->config['MANIAEXCHANGE_WIDGET'][0]['BACKGROUND_DEFAULT'][0] .'" bgcolorfocus="'. $this->config['MANIAEXCHANGE_WIDGET'][0]['BACKGROUND_FOCUS'][0] .'"/>';
			}
			else {
	...
	*/
	...
	public function buildLiveRankingsWidgetMS ($gamemode, $limit = 50) {
		...
		if ($this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_BACKGROUND'][0] != '') {
			$xml .= '<quad pos="1 -0.5625" z-index="0.004" size="'. ($this->config['LIVE_RANKINGS'][0]['WIDTH'][0] - 0.8) .' 2" bgcolor="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_BACKGROUND'][0] .'" id="RecordsEyepieceLiveRankingsBackgroundMarker" hidden="true"/>';
			$xml .= '<quad pos="-5 -0.5625" z-index="0.004" size="2 2" bgcolor="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_BACKGROUND'][0] .'"/>';
			$xml .= '<quad pos="'. $this->config['LIVE_RANKINGS'][0]['WIDTH'][0] .' -0.5625" z-index="0.004" size="2 2" bgcolor="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_BACKGROUND'][0] .'"/>';
		}
		else {
			$xml .= '<quad pos="1 -0.5625" z-index="0.004" size="'. ($this->config['LIVE_RANKINGS'][0]['WIDTH'][0] - 0.8) .' 2" style="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_STYLE'][0] .'" substyle="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_SUBSTYLE'][0] .'" id="RecordsEyepieceLiveRankingsBackgroundMarker" hidden="true"/>';
			$xml .= '<quad pos="-5 -0.5625" z-index="0.004" size="2 2" style="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_STYLE'][0] .'" substyle="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_SUBSTYLE'][0] .'"/>';
			$xml .= '<quad pos="'. $this->config['LIVE_RANKINGS'][0]['WIDTH'][0] .' -0.5625" z-index="0.004" size="2 2" style="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_STYLE'][0] .'" substyle="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_SUBSTYLE'][0] .'"/>';
		}
		$xml .= '<quad pos="-4.5 -0.9375" z-index="0.005" size="1.6 1.6" style="Icons64x64_1" substyle="ShowRight2"/>';
		$xml .= '<quad pos="'. ($this->config['LIVE_RANKINGS'][0]['WIDTH'][0] + 0.2) .' -0.9375" z-index="0.005" size="1.6 1.6" style="Icons64x64_1" substyle="ShowLeft2"/>';
		$xml .= '</frame>';
...
//		$buttons .= '<quad pos="0.1375 -0.28125" z-index="0.12" size="5.0625 5.0625" style="UIConstructionSimple_Buttons" substyle="Item"/>';
	...
	*/
	...
	public function buildScorelistWindowEntryNEW ($player, $widget, $fieldnames) {
		global $aseco;
		...
		for ($i = ($page * 100); $i < (($page * 100) + 100); $i ++) {
			...
			if (isset($item['login'])) {
				if ($item['login'] == $target) {
					if ($this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_BACKGROUND'][0] != '') {
						$xml .= '<quad pos="'. ($offset + 0.5) .' '. (((3.43125 * $line - 0.375) > 0) ? -(3.4312 * $line - 0.375) : 0.375) .'" z-index="0.03" size="43.375 3.43125" bgcolor="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_BACKGROUND'][0] .'"/>';
					}
					else {
						$xml .= '<quad pos="'. ($offset + 0.5) .' '. (((3.43125 * $line - 0.375) > 0) ? -(3.4312 * $line - 0.375) : 0.375) .'" z-index="0.03" size="43.375 3.43125" style="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_STYLE'][0] .'" substyle="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_SELF_SUBSTYLE'][0] .'"/>';
					}
				}
				else if (in_array($item['login'], $logins)) {
					if ($this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_OTHER_BACKGROUND'][0] != '') {
						$xml .= '<quad pos="'. ($offset + 0.5) .' '. (((3.43125 * $line - 0.375) > 0) ? -(3.4312 * $line - 0.375) : 0.375) .'" z-index="0.03" size="43.375 3.43125" bgcolor="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_OTHER_BACKGROUND'][0] .'"/>';
					}
					else {
						$xml .= '<quad pos="'. ($offset + 0.5) .' '. (((3.43125 * $line - 0.375) > 0) ? -(3.4312 * $line - 0.375) : 0.375) .'" z-index="0.03" size="43.375 3.43125" style="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_OTHER_STYLE'][0] .'" substyle="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['HIGHLITE_OTHER_SUBSTYLE'][0] .'"/>';
					}
				}
			}
			$xml .= '<label pos="'. (6.5 + $offset) .' -'. (3.43125 * $line) .'" z-index="0.04" size="5 3.1875" class="labels" halign="right" scale="0.9" text="'. $item['rank'] .'."/>';
			$xml .= '<label pos="'. (16 + $offset) .' -'. (3.43125 * $line) .'" z-index="0.04" size="10 3.1875" class="labels" halign="right" scale="0.9" textcolor="'. $this->config['STYLE'][0]['WIDGET_RACE'][0]['COLORS'][0]['SCORES'][0] .'" text="'. $item[$fieldnames[0]] .'"/>';
			$xml .= '<label pos="'. (17.25 + $offset) .' -'. (3.43125 * $line) .'" z-index="0.04" size="28 3.1875" class="labels" scale="0.9" text="'. $item[$fieldnames[1]] .'"/>';
...
//					$xml .= '<quad pos="0 0" z-index="0.02" size="44.375 17.25" bgcolor="BgsPlayerCard" substyle="BgRacePlayerName"/>';
//					$xml .= '<quad pos="1 -0.6749" z-index="0.04" size="42.375 3.75" style="BgsPlayerCard" substyle="ProgressBar"/>';
					$xml .= '<quad pos="0 0" z-index="0.02" size="44.375 16.5" bgcolor="222233BB"/>';
					$xml .= '<quad pos="36.425 -8.6" z-index="0.03" size="8.75 8.75" action="PluginRecordsEyepiece?Action=addMapToPlaylist&uid='. $map->uid .'" image="'. $this->config['IMAGES'][0]['WIDGET_PLUS_NORMAL'][0] .'" imagefocus="'. $this->config['IMAGES'][0]['WIDGET_PLUS_FOCUS'][0] .'"/>';
					$xml .= '<quad pos="0.5 -0.5" z-index="0.04" size="43.375 3.75" bgcolor="222233BB"/>';
					$xml .= '<label pos="15 -1.21875" z-index="0.05" size="18.25 0" class="labels" textsize="1" text="#'. ($i+1) .'"/>';
					$xml .= '<quad pos="1.5 -0.9375" z-index="0.05" size="12.5 2.8125" image="'. $this->config['IMAGES'][0]['ENVIRONMENT'][0]['LOGOS'][0][strtoupper($map->environment)][0] .'"/>';
					$xml .= '<label pos="1.5 -5.0625" z-index="0.04" size="41.5 3" class="labels" text="'. $this->handleSpecialChars($map->name) .'"/>';
					$xml .= '<quad pos="1.5 -7.975" z-index="0.04" size="3 3" image="file://Media/Flags/'. (strtoupper($map->author_nation) == 'OTH' ? 'other' : $map->author_nation) .'.dds"/>';
...
//		$buttons .= '<quad pos="0.1375 -0.281" z-index="0.12" size="5.0625 5.0625" style="UIConstructionSimple_Buttons" substyle="Item"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»No Aut$FCFhor Time"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Only Re$FCFcent Maps"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons128x128_1" substyle="LoadTrack"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»No Rec$FCFent Maps"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»No Go$FCFld Time"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Only Ra$FCFnked Maps"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="BgRaceScore2" substyle="LadderRank"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Not Ra$FCFnked Maps"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»No Sil$FCFver Time"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Only Mul$FCFtilap Maps"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons128x32_1" substyle="RT_Laps"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»No Mult$FCFilap Maps"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»All$FCF Maps"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»No Bro$FCFnze Time"/>';
		...
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons64x64_1" substyle="Close"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Not F$FCFinished"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Select $FCFAuthorname"/>';
		...
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Curren$FCFt Jukebox"/>';
		...
		$xml .= '<quad pos="0 0" z-index="0.02" size="92 16.5" bgcolor="222233BB"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.04" size="91 3.75" bgcolor="222233BB"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.05" size="3.75 3.75" style="Icons128x128_1" substyle="Manialink"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Map$FCF mood"/>';
		...
		$xml .= '<quad pos="0 0" z-index="0.02" size="187.25 16.5" bgcolor="222233BB"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.04" size="186.25 3.75" bgcolor="222233BB"/>';
		$xml .= '<quad pos="0.5 -0.5" z-index="0.06" size="3.75 3.75" style="Icons128x128_1" substyle="Advanced"/>';
		$xml .= '<label pos="5.5 -1.22" z-index="0.05" size="43.25 0" class="labels" text="$o$FCFмŁ»Map en$FCFvironment"/>';
...
EOL;
		...
		if ($this->config['STYLE'][0]['WIDGET_SCORE'][0]['BACKGROUND_COLOR'][0] != '') {
			$header .= '<quad pos="0.25 -0.1875" z-index="0.001" size="'. ($this->config['MAP_WIDGET'][0]['WIDTH'][0] - 0.5) .' 26.4375" bgcolor="222233BB'. $this->config['STYLE'][0]['WIDGET_SCORE'][0]['BACKGROUND_COLOR'][0] .'"/>';
		}
		else {
		...
		// Icon and Title
		if ($this->config['STYLE'][0]['WIDGET_SCORE'][0]['TITLE_BACKGROUND'][0] != '') {
			$header .= '<quad pos="1 -0.675" z-index="0.002" size="'. ($this->config['MAP_WIDGET'][0]['WIDTH'][0] - 2) .' 3.75" bgcolor="222233BB'. $this->config['STYLE'][0]['WIDGET_SCORE'][0]['TITLE_BACKGROUND'][0] .'"/>';
		}
		else {
...
EOL;
		...
		if ($this->config['TOPLIST_WIDGET'][0]['BACKGROUND_DEFAULT'][0] != '') {
			$content .= '<quad pos="0 0" z-index="0.001" size="11.5 12.19" bgcolor="222233BB'. $this->config['TOPLIST_WIDGET'][0]['BACKGROUND_DEFAULT'][0] .'" bgcolorfocus="'. $this->config['TOPLIST_WIDGET'][0]['BACKGROUND_FOCUS'][0] .'" scriptevents="1" id="ButtonToplistWidget"/>';
		}
		else {
		...
		$content .= '<label pos="5.75 -9.3875" z-index="0.1" size="17 2.4" halign="center" textsize="1" scale="0.6" textcolor="FFF'. $this->config['TOPLIST_WIDGET'][0]['TEXT_COLOR'][0] .'" text="RANKING"/>';
		$content .= '</frame>';
$content .= <<<EOL
<script><!--
 /*
...
EOL;
		...
		if ($this->config['NEXT_ENVIRONMENT_WIDGET'][0]['BACKGROUND_COLOR'][0] != '') {
			$content .= '<quad pos="0 0" z-index="0.001" size="27.75 12.19" bgcolor="222233BB'. $this->config['NEXT_ENVIRONMENT_WIDGET'][0]['BACKGROUND_COLOR'][0] .'"/>';
		}
		else {
		...
		$content .= '%icon%';
		$content .= '<label pos="14 -9.75" z-index="0.002" size="41.25 2.4" halign="center" textsize="1" scale="0.6" textcolor="FFF'. $this->config['NEXT_ENVIRONMENT_WIDGET'][0]['TEXT_COLOR'][0] .'" text="NEXT ENVIRONMENT"/>';
		$content .= '</frame>';
$content .= <<<EOL
<script><!--
 /*
...
EOL;
		...
		if ($this->config['VISITORS_WIDGET'][0]['BACKGROUND_DEFAULT'][0] != '') {
			$content .= '<quad pos="0 0" z-index="0.001" size="11.5 12.19" bgcolor="222233BB'. $this->config['VISITORS_WIDGET'][0]['BACKGROUND_DEFAULT'][0] .'" bgcolorfocus="'. $this->config['VISITORS_WIDGET'][0]['BACKGROUND_FOCUS'][0] .'" scriptevents="1" id="ButtonVisitorsWidget"/>';
		}
		else {
		...
		$content .= '<label pos="5.75 -9.3875" z-index="0.1" size="17 2.4" halign="center" textsize="1" scale="0.6" textcolor="FFF'. $this->config['VISITORS_WIDGET'][0]['TEXT_COLOR'][0] .'" text="VISITORS"/>';
		$content .= '</frame>';
$content .= <<<EOL
<script><!--
 /*
...
EOL;
		...
		$footer .= '<label pos="5.75 -9.3875" z-index="0.1" size="17 2.4" halign="center" textsize="1" scale="0.6" textcolor="FFF'. $this->config['MANIAEXCHANGE_WIDGET'][0]['TEXT_COLOR'][0] .'" text="%text%"/>';
		$footer .= '</frame>';
$footer .= <<<EOL
<script><!--
 /*
...
EOL;
		...
		if ($this->config['MAPCOUNT_WIDGET'][0]['BACKGROUND_DEFAULT'][0] != '') {
			$content .= '<quad pos="0 0" z-index="0.001" size="11.5 12.19" bgcolor="222233BB'. $this->config['MAPCOUNT_WIDGET'][0]['BACKGROUND_DEFAULT'][0] .'" bgcolorfocus="'. $this->config['MAPCOUNT_WIDGET'][0]['BACKGROUND_FOCUS'][0] .'" scriptevents="1" id="ButtonMapCountWidget"/>';
		}
		else {
		...
		$content .= '<label pos="5.75 -9.3875" z-index="0.1" size="17 2.4" halign="center" textsize="1" scale="0.6" textcolor="FFF'. $this->config['MAPCOUNT_WIDGET'][0]['TEXT_COLOR'][0] .'"  text="MAPS"/>';
		$content .= '</frame>';
$content .= <<<EOL
<script><!--
 /*
...
EOL;
		...
		$content .= '<label pos="5.75 -9.3875" z-index="0.1" size="17 2.4" halign="center" textsize="1" scale="0.6" textcolor="FFF'. $this->config['FAVORITE_WIDGET'][0]['TEXT_COLOR'][0] .'" text="FAVORITE"/>';
		$content .= '</frame>';
