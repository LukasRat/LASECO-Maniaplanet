	...
	*/
	...
	private function buildReplay ($aseco, $state = false) { //Build replay widget
		...
		if ($this->p2p['style']['background_default'] != '') {
			$layout = 'bgcolor="222233BB'. $this->p2p['style']['background_default'] .'" bgcolorfocus="'. $this->p2p['style']['background_focus'] .'"';
		}
		else {
		...
		if ($state == 'success') {
			...
			<label pos="5.625 -1.40625" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.9" textcolor="FFF" text="PAY '.$this->p2p['replay']['cost'].'"/>
			<label pos="5.625 -4.3125" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.6" textcolor="FFF" text="PLANETS"/>
			<label pos="5.625 -6.65625" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.9" textcolor="FFF" text="FOR"/>
			<label pos="5.625 -9.375" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.6" textcolor="FFF" text="REPLAY"/>
			</frame>
			</manialink>';
		}
		$aseco->addManialink($xml, false, 0, false);
	...
	*/
	...
	private function buildSkip ($aseco, $state = false) { //Build skip widget
		...
		if ($state == 'success') {
			...
			<label pos="5.625 -1.40625" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.9" textcolor="FFF" text="PAY '.$this->p2p['skip']['cost'].'"/>
			<label pos="5.625 -4.3125" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.6" textcolor="FFF" text="PLANETS"/>
			<label pos="5.625 -6.65625" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.9" textcolor="FFF" text="FOR"/>
			<label pos="5.625 -9.375" z-index="0.1" size="12.5 3.75" halign="center"  textsize="1" scale="0.6" textcolor="FFF" text="SKIP"/>
			</frame>
			</manialink>';
